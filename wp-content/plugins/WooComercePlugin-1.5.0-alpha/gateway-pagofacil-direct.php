...
class woocommerce_pagofacil_direct extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->sucursal 	= $this->get_option( 'sucursal' );
                $this->ecommercesource 	= $this->get_option( 'ecommercesource' );
...
//		$this->divisa		= $this->get_option( 'divisa' );
    ...
    function init_form_fields() {
    	...
    	$this->form_fields = array(
            ...
            'ecommercesource' => array(
                'title' => __( 'E-Commerce Platform ID', 'pagofacil' ),
                'type' => 'text',
                'description' => __( 'Please enter your E-Commerce identyfier string.', 'pagofacil' ),
                'default' => 'Woocommerce Api',
            ),
            'sendemail' => array(
...
/*			'enabledivisa' => array(
    ...
    function payment_fields() {
            ...
            ?>
            <input id="idSucursal" name="idSucursal" type="hidden" value="<?php echo $this->sucursal; ?>">
            <input id="monto" name="monto" type="hidden" value="<?php echo WC()->cart->get_cart_contents_total(); ?>">
            <p class="form-row" style="width:200px;">
                <label>Card Number <span class="required">*</span></label>
                <input class="input-text" style="width:180px;" type="text" size="16" maxlength="16" id="creditcard" name="pagofacil_direct_creditcard" />
            </p>
            <div class="clear"></div>
            ...
            if ($this->msi == 'yes') {
                ...
                <p class="form-row" style="width:230px;">
                    ...
                    <select name="pagofacil_direct_msi" id="pagofacil_direct_msi" style="width:210px;">
                ...
                <script type="text/javascript">
                    jQuery(document).ready(function($) { startMsi(); });
                </script>
                <?php
            }
        }
